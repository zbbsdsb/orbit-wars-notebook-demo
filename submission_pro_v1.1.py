# -*- coding: utf-8 -*-
"""
Orbit Wars Heuristic Agent v1.1 - PROFESSIONAL OPTIMIZED VERSION
Target: 900+ Score
Changes from v1.0:
- Much more aggressive attack strategy
- No unnecessary defense reserves
...
if __name__ == "__main__":
    print("Orbit Wars Heuristic Agent v1.1 - PROFESSIONAL")
    print("=" * 60)
